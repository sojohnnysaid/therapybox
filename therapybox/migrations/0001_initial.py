# Generated by Django 3.1.4 on 2021-01-10 01:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('location', models.CharField(blank=True, choices=[('STORAGE', 'Storage')], default='STORAGE', max_length=40)),
                ('status', models.CharField(blank=True, choices=[('AVAILABLE', 'Available'), ('REGION_2', 'Region 2')], default='AVAILABLE', max_length=40)),
