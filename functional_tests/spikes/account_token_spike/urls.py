...
from users.views import UsersRegisterView, UsersRegisterFormSubmittedView, UsersLoginView, UsersAccountActivationView
...
urlpatterns = [
    ...
    path('login/', UsersLoginView.as_view(), name='users_login')
]